var canvas = document.getElementById("canvastext"), ctx = canvas.getContext("2d"), W = window.innerWidth, H = window.innerHeight, text = "2022", text2 = "Ch\u00fac M\u1eebng N\u0103m M\u1edbi", skipCount = 4, gravity = .2, touched = !1, mouse = {}, minDist = 20, bounceFactor = .6; canvas.height = H; canvas.width = W; function trackPos(a) { mouse.x = a.pageX; mouse.y = a.pageY }
